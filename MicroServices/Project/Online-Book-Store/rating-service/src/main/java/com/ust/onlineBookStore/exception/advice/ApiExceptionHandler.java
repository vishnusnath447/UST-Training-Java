package com.ust.onlineBookStore.exception.advice;
...
import com.ust.onlineBookStore.exception.dto.ApiError;
import com.ust.onlineBookStore.exception.dto.ApiValidationError;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleBookNotFoundException(RatingNotFoundException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
    @ExceptionHandler(BookAlreadyRatedException.class)
    protected ResponseEntity<Object> handleBookNotFoundException(BookAlreadyRatedException ex) {
